...
export const SECRET_KEYS = {
    ...
    AGENTROUTER: 'api_key_agentrouter',
...
const FRIENDLY_NAMES = {
    ...
    [SECRET_KEYS.AGENTROUTER]: 'AgentRouter',
    [SECRET_KEYS.VENICE]: 'Venice AI',
    [SECRET_KEYS.NOVEL]: 'NovelAI',
    [SECRET_KEYS.CLAUDE]: 'Claude',
    [SECRET_KEYS.OPENROUTER]: 'OpenRouter',
    [SECRET_KEYS.REQUESTY]: 'Requesty',
    ...
    [SECRET_KEYS.FISH_AUDIO]: 'Fish Audio',
    ...
    [SECRET_KEYS.META]: 'Meta Model API',
    ...
    [SECRET_KEYS.ATLASCLOUD]: 'Atlascloud',
...
const INPUT_MAP = {
    ...
    [SECRET_KEYS.AGENTROUTER]: '#api_key_agentrouter',
    [SECRET_KEYS.VENICE]: '#api_key_venice',
    [SECRET_KEYS.NOVEL]: '#api_key_novel',
    [SECRET_KEYS.CLAUDE]: '#api_key_claude',
    [SECRET_KEYS.OPENROUTER]: '.api_key_openrouter',
    [SECRET_KEYS.REQUESTY]: '#api_key_requesty',
    ...
    [SECRET_KEYS.NVIDIA]: '#api_key_nvidia',
    ...
    [SECRET_KEYS.ATLASCLOUD]: '#api_key_atlascloud',
