        ...
        switch (main_api) {
            ...
            case 'openai':
                if (((secret_state[SECRET_KEYS.OPENAI] || oai_settings.reverse_proxy) && oai_settings.chat_completion_source == chat_completion_sources.OPENAI)
                    ...
                    || (secret_state[SECRET_KEYS.NVIDIA] && oai_settings.chat_completion_source == chat_completion_sources.NVIDIA)
                    ...
                    || (secret_state[SECRET_KEYS.META] && oai_settings.chat_completion_source == chat_completion_sources.META)
                    ...
                    || ((secret_state[SECRET_KEYS.MINIMAX] || oai_settings.reverse_proxy) && oai_settings.chat_completion_source == chat_completion_sources.MINIMAX)
